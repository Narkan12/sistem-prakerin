...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2026 at 05:18 PM
...
(12, 'User01', '202cb962ac59075b964b07152d234b70', 'User', 'Nonaktif');
...
--
ALTER TABLE `guru`
  ADD CONSTRAINT `guru_ibfk_1` FOREIGN KEY (`id_pengguna`) REFERENCES `pengguna` (`id_pengguna`) ON DELETE CASCADE;
